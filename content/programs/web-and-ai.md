...
features:
  - "Foundations: computer basics, internet, Git, essential digital tools"
  - "Frontend: HTML, CSS, JavaScript, responsive design, React framework"
  - "Introduction to AI: connecting LLMs to web applications in practical ways"
  - "Capstone Project: design and develop your own application, presented at Demo Day"
  - "Live mentorship from female mentors in Afghanistan and abroad"
  - "Full scholarships, internet packages, and laptop support available"
---
...
This year's bootcamp is led by **Jamshid Hashimi**, who guides students through the structured curriculum. Alongside him, a group of dedicated **female mentors from Afghanistan and abroad** join live sessions to share professional experiences, answer questions, and encourage learners with their own stories.
